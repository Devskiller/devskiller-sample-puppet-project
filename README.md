...
This repo contains a sample project for Puppet and below you can
...
Every Puppet module in your project will be tested with the following commands:
...
`[module_name] Verification` string and are located in `spec` subdirectories. In
